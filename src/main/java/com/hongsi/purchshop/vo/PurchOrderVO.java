...
CREATE TABLE PURCH_ORDER_TRACE (
...
SALEPATH VARCHAR2(30 BYTE), 
ORDERER VARCHAR2(40 BYTE), 
COMM VARCHAR2(200 BYTE), 
MANAGER VARCHAR2(20 BYTE), 
GUBUNCODE VARCHAR2(30 BYTE), 
STATUS VARCHAR2(30 BYTE), 
ADMIT VARCHAR2(10 BYTE), 
RDATE DATE DEFAULT SYSDATE, 
FLAG NUMBER );
		        
CREATE SEQUENCE PURCHORDER_TRACE_PK
INCREMENT BY 1
START WITH 1
MAXVALUE 99999;	
