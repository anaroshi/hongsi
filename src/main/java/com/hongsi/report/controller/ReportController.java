...
public class ReportController {	
	...
	public String excelDownload(@RequestParam Map<String, Object> paramMap, Model model, HttpServletResponse res) throws Exception {
		...
		// 재료구매 리스트 화면
		log.info(".............................buyAllList..");
		model.addAttribute("buyList", purchIngSerivce.list());
		
		// 재료 입출고 리스트
		log.info(".............................storageAllList..");
		model.addAttribute("inOutList", purchIngSerivce.selectStorageInOut());
